...
class ProjetoDAO:
    ...
    def create(self, objProjeto: Projeto) -> int:
        ...
        try:
            SQL = """
                ...
                (nome, descricao, data_inicio, data_fim, data_limite, status, usuario_id, data_criacao, data_atualizacao) 
                VALUES (%s, %s, %s, %s, %s, %s)
            """
            params = (
                objProjeto.nome,
                ...
                objProjeto.data_fim,
                objProjeto.data_limite,
                objProjeto.status,
                objProjeto.usuario_id,
                objProjeto.data_criacao,
                objProjeto.data_atualizacao,
            )
    ...
    def update(self, objProjeto: Projeto) -> bool:
        ...
        try:
            ...
            SQL = """
                UPDATE projetos 
                SET nome=%s, descricao=%s, data_inicio=%s, data_fim=%s, data_limite = %s, status=%s, data_criacao = %s, data_atualizacao = %s
    ...
    def _row_to_dict(self, row: dict) -> dict:
        ...
        date_fields = ["data_inicio", "data_fim", "data_limite","data_criacao", "data_atualizacao"]
